...
class Nonce {
	...
	public const RSES_ACTION_FORCE_LOGOUT       = 'rses_force_logout';
	public const RSES_ACTION_UNBAN_USER         = 'rses_unban_user';
	public const RSES_ACTION_URL_HARDENING      = 'rses_url_hardening';
