	...
	public static function rses_render(): void {
		...
		<div class="wrap rses-wrap rses-screen" <?php echo Translator::rses_html_attrs(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			<section class="rses-panel rses-panel-card">
				...
				<p><?php esc_html_e( 'Creates (or reuses) welcome, voting booth, and thank-you pages with default shortcode content. You can edit them in Pages afterward. The Votador password-change PoC uses WordPress “Lost password” / “Recuperar minha senha” before login (Roundcube); [enviar_redefinicao_senha] remains optional for manual logged-in tests.', 'relatasoft-secure-election-suite' ); ?></p>
