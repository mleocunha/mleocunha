<?php
/**
 * Optional theme Customizer extras (login branding is owned exclusively by the Painel plugin module).
 *
	...
	public static function register( \WP_Customize_Manager $wp_customize ): void {
		$wp_customize->add_section(
			...
			array(
				...
				'description' => I18n::translate( 'Optional theme extras. Login screen is owned by Voto Eletrônico Painel (plugin); the theme does not brand wp-login.php.' ),
				'priority'    => 35,
			)
		);
